...
class Thermistor {  //Thermistor class and function
  String Name = Defaults.Thermistor.Name;
  void setNameTo(String newName) {
    this.Name = newName;
  }
...
ArrayList<Thermistor> thermistors = new ArrayList<Thermistor>();
float max_100uA_band = 0, max_10uA_band = 0, min_resistanceTolerance = Float.MAX_VALUE;